	...
	<div id="wrap">
		...
		<jsp:include page="/WEB-INF/jsp/wzwg/cmm/include/incDecoMngrHeader.jsp" />
          ...
          <div id="contents">
            ...
            <c:if test="${fn:indexOf(nowUrl, '/mngr/api/') > -1}"><c:set var="locationNm"><spring:message code="wzwg.cmm.cntnts.apimanage" /></c:set></c:if>
            <c:if test="${fn:indexOf(nowUrl, '/mngr/module/api/') > -1}"><c:set var="locationNm"><spring:message code="wzwg.cmm.cntnts.apimanage" /></c:set></c:if>
