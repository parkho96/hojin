 ...
 <body>  
		...
		<jsp:include page="/WEB-INF/jsp/wzwg/cmm/include/incDecoMngrHeader.jsp" />
          ...
          <div id="contents">
            ...
            <c:if test="${fn:indexOf(nowUrl, '/mngr/subsite/info/') > -1}"><c:set var="locationNm"><spring:message code="wzwg.cmm.cntnts.subsitelist"/></c:set></c:if>
						<div class="location-001">
							<ul>
								 <li><img src="/images/wzwg/site/mngr/lo-home.png" alt="<spring:message code="wzwg.cmm.word.home" />" /></li>
								 <li><spring:message code="wzwg.cmm.cntnts.subsitemanage" /></li>
