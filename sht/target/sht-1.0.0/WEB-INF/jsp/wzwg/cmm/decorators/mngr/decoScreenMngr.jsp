          ...
          <div id="contents">
				<div id="main">
					...
					<c:set var="locationNm" />
					 <c:if test="${fn:indexOf(nowUrl, '/screen/selectSiteScreenTempltMain.do') > -1}"><c:set var="locationNm"><spring:message code="wzwg.cmm.menu.mainTempltMngr"/></c:set></c:if>
					 <c:if test="${fn:indexOf(nowUrl, '/sysMngr/screen/') > -1}"><c:set var="locationNm"><spring:message code="wzwg.cmm.cntnts.templatemanage"/></c:set></c:if>
					 <c:if test="${fn:indexOf(nowUrl, '/subCss/') > -1}"><c:set var="locationNm"><spring:message code="wzwg.cmm.menu.subCssMngr"/></c:set></c:if>
