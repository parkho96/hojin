...
<style type="text/css">
	...
	.fileplus li a{float:left; padding:5px 13px; margin-left:3px; line-height:13px;}
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#regist_btn').click(function(){
			...
			if(!confirm('<spring:message code="wzwg.cmm.cmmMsg.CMG007"><spring:argument><spring:message code="wzwg.cmm.word.stre" text="save" /></spring:argument></spring:message>')){
				...
				$.ajax({
					  type : 'POST'
					, url : '<c:out value="${wzwg_contextPath}" /><c:out value="${prefix}" />/module/onlineReqst/registOnlineReqstNttAjax.do'
	...
	<span class="wd100 txt-r fw400 fl" style="font-size: 12px;">( <strong class="red">*</strong>:<spring:message code="wzwg.cmm.word.essntl" />)</span>
	...
	<table class="basic">
		  ...
		  <tbody>
			<tr>
				...
				<td><input type="text" id="reqstnttSj" name="reqstnttSj" value="" class="w80"/></td>
			</tr>
			<tr>
				<th><spring:message code="wzwg.module.word.reqstpd" /><span class="red">*</span></th>
				<td>
					<input type="text" id="bgnde" name="bgnde" class="datePicker cal" style="width:150px;" readonly="readonly" title="<spring:message code="wzwg.cmm.word.bgnde" />" value="" /> 
					...
					~ 
					<input type="text" id="endde" name="endde" class="datePicker cal" style="width:150px;" readonly="readonly" title="<spring:message code="wzwg.cmm.word.endde" />" value="" />
			...
			<tr>
				...
				<td>
					<input type="text" id="psncpa" name="psncpa" value="0" class="w10"/><spring:message code="wzwg.cmm.word.person" />
				...
				<td>
					...
					<ul>
						<c:choose>
							...
							<c:otherwise><spring:message code="wzwg.cmm.msg.MSG104" /></c:otherwise>
						</c:choose>
					</ul>
				</td>
			</tr>						
			<tr>
				...
				<td>
					...
					<textarea id="reqstnttCn" name="reqstnttCn" rows="20" style="width:100%;"></textarea>
	...
	<div class="rt-box">
		<a href="javascript:void(0);" id="regist_btn" class="wzbtn btn-save"><spring:message code="wzwg.cmm.word.regist" /></a>
