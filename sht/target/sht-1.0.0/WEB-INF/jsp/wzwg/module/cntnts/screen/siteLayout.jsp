					...
					<c:set var="layoutView_2_3_7" value="false"></c:set>
						...
						<div id="add_layer" class="pop-tab">
				            ...
				            <section class="buttons">
				                <c:if test="${variableLayoutView eq 'true'}">
				                <label for="add_layer_variableLayout"><spring:message code="wzwg.module.word.cmpndlayout" /></label>
				                </c:if>
				                <label for="add_layer_first"><spring:message code="wzwg.module.word.fixinglayout" /></label>
				                <label for="add_layer_second"><spring:message code="wzwg.module.word.layoutintrvlandse" /></label>
				            </section>
