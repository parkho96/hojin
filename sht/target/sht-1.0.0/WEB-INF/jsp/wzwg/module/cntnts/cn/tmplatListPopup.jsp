...
<script type="text/javascript">
	...
	function fn_cntntsTmplatPrevew(paramSeq){
		...
		var frmResult = window.open("", "popForm", "width=1100,height=800,toolbars=no,menubars=no,scrollbars=yes");
	...
	function fnTmplatChange(paramSeq, paramFileId){
		if(!confirm('<spring:message code="wzwg.cmm.cmmMsg.CMG006">'+
	       ...
	       $.ajax({
	              type : 'POST'
	            , dataType: 'html'
	            , url : '<c:out value="${wzwg_contextPath}${prefix}"/>/module/cntnts/selectCntntsCnAjax.do'
	            , cache : false
	            , async : false
