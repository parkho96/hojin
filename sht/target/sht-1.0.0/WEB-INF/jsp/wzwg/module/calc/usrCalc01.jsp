...
function calc1(){
	...
	var rate = parseFloat(exprNumber($('#inp-a-rate').val()));
	...
	clac1Process($('#a-row-3'), price, rate);
	clac1Process($('#a-row-6'), price, rate);
	clac1Process($('#a-row-12'), price, rate);
	clac1Process($('#a-row-24'), price, rate);
	clac1Process($('#a-row-36'), price, rate);
	
	
}

function clac1Process(row, price, rate){
...
function calc2(){
	...
	var rate = parseFloat(exprNumber($('#inp-b-rate').val()));
	...
	clac2Process($('#b-row-12'), price, rate);
	clac2Process($('#b-row-24'), price, rate);
	clac2Process($('#b-row-36'), price, rate);
	
	
}

function clac2Process(row, price, rate){
...
function calc3(){
	...
	var rate = parseFloat(exprNumber($('#inp-c-rate').val()));
	...
	clac3Process($('#c-row-12'), price, rate);
	clac3Process($('#c-row-24'), price, rate);
	clac3Process($('#c-row-36'), price, rate);
	
}

function clac3Process(row, price, rate){
...
<div id="calcContents">
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<!-- 서브콘텐츠 상품소개 -->
			<br>
			<div class="subCon_carcul01">
				<div class="tit">
					<h3>정기예탁금</h3>	
					<div class="div_inputbtn">
						<span>이율 : </span>
						<input name="inp-a-rate" id="inp-a-rate" type="text" style="width: 60px">
						<span>예치금액 : </span>
						<input name="inp-a" id="inp-a" type="text">
					...
					<table border="1" cellpadding="0" cellspacing="0">
						...
						<tbody>
							<tr id="a-row-3" data-month="3">
								<th><div>3개월</div></th>
								<td><div><span class="rate"></span></div></td>
			...
			<div class="subCon_carcul01">
				<div class="tit">
					...
					<div class="div_inputbtn">
						<span>이율 : </span>
						<input name="inp-b-rate" id="inp-b-rate" type="text" style="width: 60px">
						<span>계약금액 : </span>
			...
			<div class="subCon_carcul01">
				<div class="tit">
					...
					<div class="div_inputbtn">
						<span>이율 :</span>
						<input name="inp-c-rate" id="inp-c-rate" type="text" style="width: 60px">
						<span>계약금액 :</span>
