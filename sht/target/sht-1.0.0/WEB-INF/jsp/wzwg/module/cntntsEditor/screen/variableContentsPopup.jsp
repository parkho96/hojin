	...
	<input type="hidden" name="imgSrc"/>
						 ...
						 <div id="addContentPopup" class="pop-tab">
					            ...
					            <section class="buttons">
					                <label for="ctnt_basic">기본</label>
					                <label for="ctnt_table">표(테이블)</label>
									...
									<ul>
										...
										<li>
											...
											<div class="btnbox-l  wd100">
												...
												<a href="javascript:void(0);" onclick="fnImgPrevewPop('imb_thumb_<c:out value="${list.widgSeq }"/>');" class="wzbtn-table btn-basic" title="확대보기"><spring:message code="wzwg.cmm.word.preview" /></a> <!-- 돋보기버튼_ 클릭시 팝업 -->
											</div>
										</li>
										</c:if>
										</c:forEach>
								...
								<%-- <div class="tab_item ${tabItemClass }">
									...
									<ul>
										...
										<li>
											...
											<a href="javascript:void(0);" onclick="fnImgPrevewPop('imb_thumb_${list.widgSeq }');" class="big_btn" title="확대보기"><spring:message code="wzwg.cmm.word.preview" /></a> <!-- 돋보기버튼_ 클릭시 팝업 -->
										</li>
										</c:if>
										</c:forEach>
									</ul>
									...
									<ul>
										...
										<li>
											...
											<div class="btnbox-l  wd100">
												...
												<a href="javascript:void(0);" onclick="fnImgPrevewPop('imb_thumb_aa');" class="wzbtn-table btn-basic" title="확대보기"><spring:message code="wzwg.cmm.word.preview" /></a> <!-- 돋보기버튼_ 클릭시 팝업 -->
											</div>
										</li>
