...
<script type="text/javascript">
    ...
    function fnRegist(callGubun) {
        ...
        var ajaxUrl = '<c:out value="${wzwg_contextPath}${prefix}"/>/module/bbs/cl';
    ...
    function fnCssInfo() {
        ...
        <form:form modelAttribute="resultVO" path="regForm" id="regForm" name="regForm" method="post">
            ...
            <tbody>
                ...
                <tr>
                    <th><spring:message code="wzwg.module.word.nttcnrsuseat" />
						<div class="menu_help">
						    <span class="circle_no">?</span>
						    <div class="help_pop">
						    	  <spring:message code="wzwg.cmm.msg.MSG403" />                             	
