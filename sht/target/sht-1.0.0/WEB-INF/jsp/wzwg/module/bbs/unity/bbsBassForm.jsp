...
<script type="text/javascript">
    ...
    function fnRegist(callGubun) {
        ...
        var ajaxUrl = '<c:out value="${wzwg_contextPath}${prefix}"/>/module/bbs/unity';
    ...
    function fnCssInfo() {
        ...
        <form:form modelAttribute="resultVO" path="regForm" id="regForm" name="regForm" method="post">
            ...
            <tbody>
                ...
                <input type="hidden" name="listScrinCode" value="L">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <ul class="wzForm">
	                        <li>
	                        	<input type="radio" id="listNumCodeA" name="listNumCode" value="N" dir="required" <c:if test="${resultVO.listNumCode eq 'N' or resultVO.listNumCode eq null}">checked="true"</c:if> />
	                        	<label for="listNumCodeA"><spring:message code="wzwg.cmm.word.ntt" text="ntt" /> <spring:message code="wzwg.cmm.word.no" text="no" /></label>
	                        </li>
	                        <li>
	                        	<input type="radio" id="listNumCodeB" name="listNumCode" value="P" dir="required" <c:if test="${resultVO.listNumCode eq 'P'}">checked="true"</c:if> />
	                        	<label for="listNumCodeB"><spring:message code="wzwg.cmm.word.page" text="page" /> <spring:message code="wzwg.cmm.word.no" text="no" /></label>
	                        </li>
                        </ul>
                        ...
                        <ul class="wzForm">
                        	...
                        	<c:choose>
                        		<c:when test="${!empty resultVO.bbsSeq }">
			                    	<li style=""><input type="checkbox" id="expsrAtNo" name="expsrAt" value="N" dir="required" /><label for="expsrAtNo"><spring:message code="wzwg.module.word.postsno"/></label></li>
			                    	<li style=""><input type="checkbox" id="expsrAtWrtr" name="expsrAt" value="W" dir="required" /><label for="expsrAtWrtr"><spring:message code="wzwg.cmm.word.wrter"/></label></li>
			                    	<li style=""><input type="checkbox" id="expsrAtRgsd" name="expsrAt" value="R" dir="required" /><label for="expsrAtRgsd"><spring:message code="wzwg.cmm.word.rgsde02"/></label></li>
			                    	<li style=""><input type="checkbox" id="expsrAtIngr" name="expsrAt" value="I" dir="required" /><label for="expsrAtIngr"><spring:message code="wzwg.cmm.word.inqire"/></label></li>
                        		</c:when>
                        		<c:otherwise>
			                    	<li style=""><input type="checkbox" id="expsrAtNo" name="expsrAt" value="N" dir="required" checked/><label for="expsrAtNo"><spring:message code="wzwg.module.word.postsno"/></label></li>
			                    	<li style=""><input type="checkbox" id="expsrAtWrtr" name="expsrAt" value="W" dir="required" checked/><label for="expsrAtWrtr"><spring:message code="wzwg.cmm.word.wrter"/></label></li>
			                    	<li style=""><input type="checkbox" id="expsrAtRgsd" name="expsrAt" value="R" dir="required" checked/><label for="expsrAtRgsd"><spring:message code="wzwg.cmm.word.rgsde02"/></label></li>
			                    	<li style=""><input type="checkbox" id="expsrAtIngr" name="expsrAt" value="I" dir="required" checked/><label for="expsrAtIngr"><spring:message code="wzwg.cmm.word.inqire"/></label></li>
                        		</c:otherwise>
                        	</c:choose>
                        </ul>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <ul class="wzForm">
	                        <li>
	                        	<input type="radio" id="listCountAtY" name="listCountAt" value="Y" dir="required" <c:if test="${resultVO.listCountAt eq 'Y'}">checked="true"</c:if> />
	                        	<label for="listCountAtY"><spring:message code="wzwg.cmm.word.choise" /></label>
                ...
                <tr>
                	...
                	<td colspan="3">
                		<ul class="wzForm">
	                        <li>
	                        	<input type="radio" id="atchFilePosblAtY" name="atchFilePosblAt" value="Y" dir="required" <c:if test="${resultVO.atchFilePosblAt eq 'Y'}">checked="true"</c:if> />
	                        	<label for="atchFilePosblAtY"><spring:message code="wzwg.cmm.word.use" text="use" /></label>
               ...
               <%--  <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <a href="javascript:void(0);" id="subospec_add_btn" class="wzbtn btn-edit"><spring:message code="wzwg.cmm.word.add" text="add" /></a>
