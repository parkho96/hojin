...
function fnList(){
	...
	$.ajax({
		type:'POST'
		, url:'<c:out value="${wzwg_contextPath}" />/sysMngr/stat/selectBbsStatAjax.do'
...
function fnExcelDown(){
	document.statFrm.action="<c:out value="${wzwg_contextPath}" />/sysMngr/stat/selectBbsStatExcel.do";
