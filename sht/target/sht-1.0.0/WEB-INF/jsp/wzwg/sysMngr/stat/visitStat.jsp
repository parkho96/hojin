...
function fnList(){
	...
	$.ajax({
		type:'POST'
		, url:'<c:out value="${wzwg_contextPath}" />/sysMngr/stat/selectVisitStatAjax.do'
...
function fnExcelDown(){
	document.statFrm.action="<c:out value="${wzwg_contextPath}" />/sysMngr/stat/selectVisitStatExcel.do";
...
<div class="rt-box"> 
    <a class="wzbtn btn-green ico-excel fr" id="regist_btn" onclick="fnExcelDown();" href="javascript:void(0);"><spring:message code="wzwg.sysMngr.word.excelDwld" text="엑셀 다운로드" /></a> 
</div>