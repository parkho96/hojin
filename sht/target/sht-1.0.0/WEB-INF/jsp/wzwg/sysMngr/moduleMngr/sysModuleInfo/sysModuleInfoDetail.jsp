...
//수정
function fnSysModuleInfoModify() {
    ...
    frm.action="<c:out value="${wzwg_contextPath}"/>/sysMngr/moduleMngr/sysModuleInfo/modifySysModuleInfo.do";
    frm.submit();
}

//삭제
function fnSysModuleInfoDelete() {
    var frm = document.frmReg;
    frm.action="<c:out value="${wzwg_contextPath}"/>/sysMngr/moduleMngr/sysModuleInfo/deleteSysModuleInfo.do";
    frm.submit();
}
...
function fnList() {
    ...
    frm.submit();
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form:select path="moduleTyCode" id="moduleTyCode" dir="required">	
                                    	<form:option value="">${fn:escapeXml(msg_txt01)}</form:option>
                             ...
                             <tr>
                                ...
                                <td>
	                                <c:set var="msg_txt02">
										<spring:message code="wzwg.cmm.cmmMsg.CMG011">
											<spring:argument><spring:message code="wzwg.cmm.word.mdNm01" /></spring:argument>
											<spring:argument><spring:message code="wzwg.cmm.word.input" /></spring:argument>
										</spring:message>
									</c:set>
                             ...
                             <tr>
                                ...
                                <td>
                                    ...
                                    <form:input cssClass="w70" path="usrPageUrl" id="usrPageUrl" dir="required" placeholder="${fn:escapeXml(msg_txt07)}"/>
                                </td>
                            </tr>
						</tbody>
					</table>
				...
				<div class="rt-box">
					<a href="javascript:void(0);" onclick="fnSysModuleInfoDelete(); return false;" class="btn-b fl"><spring:message code="wzwg.cmm.word.delete" /></a>
					<a href="javascript:void(0);" onclick="fnSysModuleInfoModify(); return false;" class="btn-a"><spring:message code="wzwg.cmm.word.updt" /></a>
