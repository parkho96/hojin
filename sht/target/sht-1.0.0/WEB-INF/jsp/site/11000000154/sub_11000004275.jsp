...
<!-- middle_contents -->
	...
	<div class="inner">
		...
		<div id="sub_visual" class="mainBanner topSubImgOrign"> 
			<img src="/sample/template/basic/basic033/img/mv_03.jpg" alt="" />
			<div class="bluebg">
		    ...
		    <c:choose>
               ...
               <div class="subCon">
				<ul class="location" id="menuLocationPath">
					...
					<li><a href="<c:out value="${wzwg_contextPath}"/>/subList/<c:out value="${mnSeqArr[s.index]}"/>"><c:out value="${mnPath}" escapeXml="false"/></a></li>
					</c:forEach>
				</ul>
