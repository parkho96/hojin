...
<!-- middle_contents -->
	...
	<div class="inner">
		...
		<div id="sub_visual" class="mainBanner topSubImgOrign"> 
			<img src="/sample/template/basic/basic022/img/mv_03.jpg" alt="" />
			<div class="bluebg">
		...
		<div class="sub_div_wrap">
			...
			<c:set var="mnPathArr" value="${fn:split(menuPath, '>') }"/>
			<c:set var="mnSeqArr" value="${fn:split(menuPathSeq, '>') }"/>
               <div class="subCon">
				<ul class="location" id="menuLocationPath">
					<li class="home"><a href="/">HOME</a></li>
					<c:forEach items="${mnPathArr}" varStatus="s" var="mnPath">
					<li><a href="${wzwg_contextPath}/subList/${mnSeqArr[s.index]}"><c:out value="${mnPath}" escapeXml="false"/></a></li>
					</c:forEach>
				</ul>

				<h4 class="tit" id="menuTitle"><c:out value="${menuNm }" escapeXml="false"/></h4>
				<p  id="menuInfo"> </p>
				<div>
