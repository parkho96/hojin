...
public class EgovLoginLogServiceImpl extends EgovAbstractServiceImpl implements
	 ...
	 * @param LoginLog
	 */
	public List<LoginLog> selectMngrLoginLogInfoList(LoginLog loinLog) throws Exception {
		return loginLogDAO.selectMngrLoginLogInfoList(loinLog);
	}
	 ...
	 * @param LoginLog
	 */
	public int selectMngrLoginLogInfoCnt(LoginLog loinLog) throws Exception {
		return loginLogDAO.selectMngrLoginLogInfoCnt(loinLog);
	}
