...
public class WebLogDAO extends EgovAbstractMapper {
	...
	public void logInsertWebLog(WebLog webLog) throws Exception{
		insert("WebLogDAO_logInsertWebLog", webLog);
	}
	...
	public void logInsertWebLogSummary() throws Exception{
		insert("WebLogDAO_logInsertWebLogSummary", null);
		delete("WebLogDAO_logDeleteWebLogSummary", null);
	}
	...
	public WebLog selectWebLog(WebLog webLog) throws Exception{
		...
		return (WebLog) selectOne("WebLogDAO_selectWebLog", webLog);
	}	
	...
	public List selectWebLogInf(WebLog webLog) throws Exception{
		return selectList("WebLogDAO_selectWebLogInf", webLog);
	}
	...
	public int selectWebLogInfCnt(WebLog webLog) throws Exception{
		...
		return (Integer)selectOne("WebLogDAO_selectWebLogInfCnt", webLog);
	}
