package egovframework.wzwg.sysMngr.usrMngr.usrInfo.web;
 ...
 */
@Controller
public class SysMngrUsrInfoController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/usrMngr/usrInfo/selectUsrInfoList.do","/{siteKey}/**/usrMngr/usrInfo/selectUsrInfoList.do"})
	public String selectUsrInfoList(
        ...
        /** =================== paging 끝 =============================== */
        if(session.getAttribute("SYSMNGR_AT") !=null && session.getAttribute("SYSMNGR_AT").toString().equals("Y")){
      ...
      for(int i =0;i<usrInfoList.size();i++){
		...
		return "wzwg/sysMngr/usrMngr/usrInfo/usrInfoList";
	}

	/**
	 * ㅁ 시스템 - 사용자관리 - 사용자정보 수정 폼
	 * @param request
	 * @param model
	 * @return
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/usrMngr/usrInfo/modifyUsrInfoForm.do","/{siteKey}/**/usrMngr/usrInfo/modifyUsrInfoForm.do"})
	public String usrInfoModifyForm(
            @ModelAttribute("paramVO") SysMngrUsrInfoVO paramVO
  	...
  	siteUsrLogService.insertSiteUsrLog(siteUsrLogVO);
		...
		return "wzwg/sysMngr/usrMngr/usrInfo/usrInfoModifyForm";
		
	}

	/**
	 * ㅁ 시스템 - 사용자관리 - 사용자정보 수정
	 * @param request
	 * @param model
	 * @return
	 * @throws Exception
	 */
	@RequestMapping(value="/**/usrMngr/usrInfo/modifyUsrInfo.do")
	public ModelAndView modifyUsrInfo(
            @ModelAttribute("paramVO") SysMngrUsrInfoVO paramVO
		...
		int modifyResult = usrInfoService.modifyUsrInfo(paramVO);
        ...
        mngrAuthVO.setUserId(loginVO.getUserId());
        mngrAuthService.registMngrConAuth(mngrAuthVO);
        
        if(("10000000307").equals(paramVO.getUsrtySeq())) {
    	...
    	siteUsrLogVO.setUsrlogUrl(request.getRequestURI());
    	siteUsrLogVO.setUsrlogUsrSeq(CmmSessionUtil.getLoginVO().getUsrSeq());
    	siteUsrLogVO.setUsrSeq(paramVO.getUsrSeq());
    	siteUsrLogService.insertSiteUsrLog(siteUsrLogVO);
	...
	/**
	 * ㅁ 시스템 - 사용자관리 - 사용자정보 삭제보기
	 * @param request
	 * @param model
	 * @return
	 * @throws Exception
	 */
	@RequestMapping(value="/**/usrMngr/usrInfo/deleteUsrInfo.do")
	public ModelAndView deleteUsrInfo(
			@ModelAttribute("paramVO") SysMngrUsrInfoVO paramVO
			, HttpServletRequest request 
			, ModelMap model
		) throws Exception{
		...
		int deleteResult = usrInfoService.deleteUsrInfo(paramVO,request);
	...
	/**
	 * ㅁ 시스템 - 사용자관리 - 가입정보 설정 화면
	 * @param request
	 * @param model
	 * @return
	 * @throws Exception
	 */
	@RequestMapping(value="/**/usrMngr/usrInfo/selectUsrInfoForm.do")
	public String selectUsrInfoForm(
			@ModelAttribute("paramVO") SysMngrUsrInfoVO paramVO
			, HttpServletRequest request 
			, ModelMap model
		) throws Exception{

		model.addAttribute("resultVO", new SysMngrUsrInfoVO());
		model.addAttribute("paramVO", paramVO);
				
		return "wzwg/sysMngr/usrMngr/usrInfo/usrInfoForm"; 
	}
     ...
     * @throws Exception
     */
    @RequestMapping(value="/**/usrMngr/usrInfo/modifyUsrSttus.do")
    public ModelAndView modifyUsrSttus(
            @ModelAttribute("paramVO") SysMngrUsrInfoVO paramVO
            , HttpServletRequest request 
            , ModelMap model
        ) throws Exception{
        ...
        int deleteResult = usrInfoService.modifyUsrSttus(paramVO,request);
