...
@Controller
public class OpnsuNttUnityDataManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/selectNttListAjax.do")
	public String selectNttList(
    	...
    	if("10000000001".equals(bbsSeq) || "10000000002".equals(bbsSeq) || "10000000004".equals(bbsSeq)) {
    		paramVO.setSiteSeq("");
    	}
		...
		if(paramVO.getPageIndex() == 1 && "".equals(paramVO.getSearchCondition())){
			noticeList = nttUnityService.selectNttNoticeList(paramVO);
		}
		...
		String returnPage = "nttList";	
		
		if(bbsSeq != null && "10000000004".equals(bbsSeq)) {
			returnPage  = "nttFaqList";
		}
		
		// 목록
		List<OpnsuNttVO> resultList = nttUnityService.selectNttList(paramVO);
		...
		return "wzwg/sysMngr/opnsu/ntt/unity/" + returnPage;
		
	}
	
	/**
	 * ㅁ 통합게시물 - 데이터관리 - 공지게시물 삭제
	 * @param request
	 * @param model
	 * @return
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/modifyNttNoticeAjax.do")
	public ModelAndView modifyNttNotice(
		...
		result = nttUnityService.modifyNttNotice(paramVO);	// 공지게시물 수정
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/selectNttDetailAjax.do")
	public String selectNttDetail(
		...
		if(resultVO != null){
			...
			if("I".equals(resultVO.getListScrinCode())) {
	        	...
	        	List<OpnsuFileVO> imageList = fileService.selectFileInfs(fileVO);
	    		model.addAttribute("imageList", imageList);
	    		
	    		return "wzwg/sysMngr/opnsu/ntt/unity/nttImageDetail"; 
			}
		...
		return "wzwg/sysMngr/opnsu/ntt/unity/nttDetail"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/registNttFormAjax.do")
	public String registNttForm(
		...
		return "wzwg/sysMngr/opnsu/ntt/unity/nttRegist"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/registNttInfoAjax.do")
	public ModelAndView registNttInfo(
	    ...
	    if (!files.isEmpty()) {
	    	//resultList = fileUtil.parseFileInf(files, "OPNSU_", 0, "", "");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/selectNttReplyFormAjax.do")
	public String selectNttReplyForm(
		...
		return "wzwg/sysMngr/opnsu/ntt/unity/nttReply"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/modifyNttFormAjax.do")
	public String modifyNttForm(
		...
		return "wzwg/sysMngr/opnsu/ntt/unity/nttModify"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/modifyNttInfoAjax.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/opnsu/ntt/unity/deleteNttInfoAjax.do")
