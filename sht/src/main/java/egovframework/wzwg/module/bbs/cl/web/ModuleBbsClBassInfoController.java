package egovframework.wzwg.module.bbs.cl.web;
...
@Controller
public class ModuleBbsClBassInfoController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/module/bbs/cl/selectBbsInc.do","/{siteKey}/**/module/bbs/cl/selectBbsInc.do"})
	public String selectBbsInc(
    	...
    	*/
		...
		return "wzwg/module/bbs/cl/bbsInc"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/module/bbs/cl/selectClBbsBassInfoAjax.do", "/**/module/bbs/cl/bbsFormAjax.do"})
	public String selectClBbsBassInfo(
			@ModelAttribute("paramVO") ModuleBbsVO paramVO
			, HttpServletRequest request 
			, ModelMap model
		) throws Exception{
		...
		// 게시판 기본정보
		resultVO = bbsClBassInfoService.selectBbsBassInfoDetail(paramVO);
		...
		return "wzwg/module/bbs/cl/bbsBassForm"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/module/bbs/cl/modifyBbsBassInfoAjax.do")
	public ModelAndView modifyBbsBassInfo(
		...
		result = bbsClBassInfoService.modifyBbsBassInfo(paramVO);	// 저장
     ...
     * @throws Exception
     */
    @RequestMapping(value="/**/module/bbs/cl/registBbsBassInfoAjax.do")
    public ModelAndView registBbsBassInfo(
        ...
        result = bbsClBassInfoService.registBbsBassInfo(paramVO);    // 저장
