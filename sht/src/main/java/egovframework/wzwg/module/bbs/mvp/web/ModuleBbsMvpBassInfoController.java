package egovframework.wzwg.module.bbs.mvp.web;
...
@Controller
public class ModuleBbsMvpBassInfoController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/module/bbs/mvp/selectBbsInc.do","/{siteKey}/**/module/bbs/mvp/selectBbsInc.do"})
	public String selectBbsInc(
		...
		return "wzwg/module/bbs/mvp/bbsInc"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/module/bbs/mvp/selectMvpBbsBassInfoAjax.do", "/**/module/bbs/mvp/bbsFormAjax.do"})
	public String selectMvpBbsBassInfo(
			@ModelAttribute("paramVO") ModuleBbsVO paramVO
			, HttpServletRequest request 
			, ModelMap model
		) throws Exception{
		...
		// 게시판 기본정보
		resultVO = bbsMvpBassInfoService.selectBbsBassInfoDetail(paramVO);
		...
		return "wzwg/module/bbs/mvp/bbsBassForm"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/module/bbs/mvp/modifyBbsBassInfoAjax.do")
	public ModelAndView modifyBbsBassInfo(
		...
		result = bbsMvpBassInfoService.modifyBbsBassInfo(paramVO);	// 저장
     ...
     * @throws Exception
     */
    @RequestMapping(value="/**/module/bbs/mvp/registBbsBassInfoAjax.do")
    public ModelAndView registBbsBassInfo(
        ...
        result = bbsMvpBassInfoService.registBbsBassInfo(paramVO);    // 저장
