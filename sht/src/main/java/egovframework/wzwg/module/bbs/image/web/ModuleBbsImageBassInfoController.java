package egovframework.wzwg.module.bbs.image.web;
...
@Controller
public class ModuleBbsImageBassInfoController {
	/** EgovPropertyService */
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/module/bbs/image/selectBbsInc.do","/{siteKey}/**/module/bbs/image/selectBbsInc.do"})
	public String selectBbsInc(
    	...
    	*/
		...
		return "wzwg/module/bbs/image/bbsInc"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/module/bbs/image/selectUnityBbsBassInfoAjax.do", "/**/module/bbs/image/bbsFormAjax.do"})
	public String selectUnityBbsBassInfo(
		...
		// 게시판 기본정보
		resultVO = bbsImageBassInfoService.selectBbsBassInfoDetail(paramVO);
		...
		return "wzwg/module/bbs/image/bbsBassForm"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/module/bbs/image/modifyBbsBassInfoAjax.do")
	public ModelAndView modifyBbsBassInfo(
		...
		result = bbsImageBassInfoService.modifyBbsBassInfo(paramVO);	// 저장
     ...
     * @throws Exception
     */
    @RequestMapping(value="/**/module/bbs/image/registBbsBassInfoAjax.do")
    public ModelAndView registBbsBassInfo(
        ...
        result = bbsImageBassInfoService.registBbsBassInfo(paramVO);    // 저장
