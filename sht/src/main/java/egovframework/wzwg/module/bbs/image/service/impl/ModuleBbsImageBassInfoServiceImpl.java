package egovframework.wzwg.module.bbs.image.service.impl;
...
@Service("ModuleBbsImageBassInfoService")
public class ModuleBbsImageBassInfoServiceImpl extends EgovAbstractServiceImpl implements ModuleBbsImageBassInfoService{
	...
	@Resource(name="ModuleBbsImageBassInfoDAO")
    protected ModuleBbsImageBassInfoDAO bbsImageBassInfoDAO;
	...
	public ModuleBbsVO selectBbsBassInfoDetail(ModuleBbsVO moduleBbsVO) throws Exception {
		return bbsImageBassInfoDAO.selectBbsBassInfoDetail(moduleBbsVO);
	}
    ...
    public int modifyBbsBassInfo(ModuleBbsVO moduleBbsVO) throws Exception {
        ...
        return bbsImageBassInfoDAO.modifyBbsBassInfo(moduleBbsVO);
    }
    ...
    public int registBbsBassInfo(ModuleBbsVO moduleBbsVO) throws Exception {
        ...
        if( attributes != null ) {
        	RequestContextHolder.getRequestAttributes().setAttribute("regist_sysModuleSeq", bbsSeq, RequestAttributes.SCOPE_SESSION);
        }
        
        return bbsImageBassInfoDAO.registBbsBassInfo(moduleBbsVO);
    }
    ...
    public String registBbsBassInfoInit(ModuleBbsVO moduleBbsVO) throws Exception {
        String bbsSeq = bbsCmmnDAO.selectBbsSeq();
        moduleBbsVO.setBbsSeq(bbsSeq);
        bbsImageBassInfoDAO.registBbsBassInfo(moduleBbsVO);
        return bbsSeq;
    }
}
