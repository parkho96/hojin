package egovframework.wzwg.module.bbs.unity.web;
...
@Controller
public class ModuleBbsUnityBassInfoController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/module/bbs/unity/selectBbsInc.do","/{siteKey}/**/module/bbs/unity/selectBbsInc.do"})
	public String selectBbsInc(
    	...
    	*/
		...
		return "wzwg/module/bbs/unity/bbsInc"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value={"/**/module/bbs/unity/selectUnityBbsBassInfoAjax.do", "/**/module/bbs/unity/bbsFormAjax.do"})
	public String selectUnityBbsBassInfo(
		...
		return "wzwg/module/bbs/unity/bbsBassForm"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/module/bbs/unity/modifyBbsBassInfoAjax.do")
     ...
     * @throws Exception
     */
    @RequestMapping(value="/**/module/bbs/unity/registBbsBassInfoAjax.do")
