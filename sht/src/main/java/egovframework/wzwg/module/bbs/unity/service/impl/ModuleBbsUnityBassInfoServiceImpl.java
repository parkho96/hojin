package egovframework.wzwg.module.bbs.unity.service.impl;
...
@Service("ModuleBbsUnityBassInfoService")
public class ModuleBbsUnityBassInfoServiceImpl extends EgovAbstractServiceImpl implements ModuleBbsUnityBassInfoService {
	...
	@Resource(name="ModuleBbsUnityBassInfoDAO")
    protected ModuleBbsUnityBassInfoDAO bbsUnityBassInfoDAO;
	...
	public ModuleBbsVO selectBbsBassInfoDetail(ModuleBbsVO moduleBbsVO) throws Exception {
		return bbsUnityBassInfoDAO.selectBbsBassInfoDetail(moduleBbsVO);
	}
    ...
    public int modifyBbsBassInfo(ModuleBbsVO moduleBbsVO) throws Exception {
        ...
        return bbsUnityBassInfoDAO.modifyBbsBassInfo(moduleBbsVO);
    }
    ...
    public int registBbsBassInfo(ModuleBbsVO moduleBbsVO) throws Exception {
        ...
        return bbsUnityBassInfoDAO.registBbsBassInfo(moduleBbsVO);
    }
    ...
    public String registBbsBassInfoInit(ModuleBbsVO moduleBbsVO) throws Exception {
        String bbsSeq = bbsCmmnDAO.selectBbsSeq();
        moduleBbsVO.setBbsSeq(bbsSeq);
        bbsUnityBassInfoDAO.registBbsBassInfo(moduleBbsVO);
        return bbsSeq;
    }
