...
@Controller
public class ModuleCntntsBassInfoController {
	 ...
	 * 컨텐츠 리스트 조회(메인)
	 */
	@RequestMapping(value={"/**/module/cntnts/selectModuleCntntsInc.do","/{siteKey}/**/module/cntnts/selectModuleCntntsInc.do"})
	public String selectModuleCntntsInc(
		...
		return "wzwg/module/cntnts/cntntsInc";
	}
	
	/** 
	 * 컨텐츠 기본정보 상세(폼)
	 */
	@RequestMapping(value={"/**/module/cntnts/selectCntntsBassInfoDetailAjax.do", "/**/module/cntnts/cntntsFormAjax.do"})
	public String registModuleCntntsFormAjax(
		...
		return "/wzwg/module/cntnts/cntntsBassForm";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/module/cntnts/selectCntntsTmplatListAjax.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/**/module/cntnts/selectCntntsTmplatListSearchAjax.do")
    public String selectCntntsTmplatListSearchAjax(
		...
		if(target != null && target.equals("cnDetail")){
			return "/wzwg/module/cntnts/cn/tmplatListPopup";
		}else{
			return "/wzwg/module/cntnts/tmplatListPopup";
		}
    }
	 ...
	 * 컨텐츠 기본정보 등록
	 */
	@RequestMapping(value="/**/module/cntnts/registModuleCntntsAjax.do")
	 ...
	 * 컨텐츠 기본정보 수정
	 */
	@RequestMapping(value="/**/module/cntnts/modifyModuleCntntsAjax.do")
	 ...
	 * 컨텐츠 템플릿정보 수정
	 */
	@RequestMapping(value="/**/module/cntnts/modifyModuleCntntsTmplatAjax.do")
