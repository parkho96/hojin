	...
	$(document).ready(function(){
		...
		$('#modify_btn').click(function(){
			...
			if(!confirm('<spring:message code="wzwg.cmm.cmmMsg.CMG007"><spring:argument><spring:message code="wzwg.cmm.word.updt" /></spring:argument></spring:message>')){
				...
				$.ajax({
			        type : 'POST'
					, url : '<c:out value="${wzwg_contextPath}${prefix}"/>/module/ntt/link/modifyNttLinkInfoAjax.do'
				...
				<div class="subject">
					...
					<tbody>		
						...
						<tr>
							...
							<td style="padding-right:5px;">
								<form:input path="linkUrl" id="linkUrl" style="width:100%;" dir="required" title="${fn:escapeXml(nttlinkTit)}" placeholder="${fn:escapeXml(placeTit)}"/>
							</td>
						</tr>
						<tr>
							<th scope="row" class="subTit">
						...
						<tr>
							...
							<td>
								<textarea title="<spring:message code="wzwg.module.word.linkdcinpcmpt" />" name="linkDc" id="linkDc" rows="10" style="width:100%;"><c:out value="${resultVO.linkDc}"/></textarea>
