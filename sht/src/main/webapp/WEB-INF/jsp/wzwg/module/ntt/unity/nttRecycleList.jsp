			...
			<table class="<c:out value='${tableCss}'/>">
				  ...
				  <thead>
					<tr>
						...
						<th><span id="frstRegistPnttm_asc"><spring:message code="wzwg.cmm.word.rgsde02" /></span></th>
						<c:if test="${mobileAt eq 'N'}">
						<th><span id="inqireCnt_asc"><spring:message code="wzwg.cmm.word.inqire" /></span></th>
						</c:if>
					</tr>
			      </thead>
				  <tbody>		  
					...
					<c:if test="${!empty resultList}">
						...
						<tr>							
							<c:if test="${adminAuthAt eq 'Y'}">
								<c:set var="nttSeq" value="${resultList.nttSeq}" />
