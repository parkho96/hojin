						...
						<tr>
							...
							<td colspan="4">
								<ul class="setlist">
									<li>
										<label>
											<form:checkbox path="answerPermAt" name="answerPermAt" value="Y" dir="required" title="${fn:escapeXml(answerPermTit)}"/> 
											<span><spring:message code="wzwg.module.word.answerperm" /></span>
										</label>
									</li>
								</ul>
							</td>
