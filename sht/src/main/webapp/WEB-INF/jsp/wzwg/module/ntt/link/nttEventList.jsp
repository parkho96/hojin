			...
			<c:if test="${!empty resultList}">
				...
				<li style="width:100%;">
					...
					<div class="event-img">
						<div class="imgbox">
							<a href="javascript:void(0);" title="<spring:message code="wzwg.cmm.word.wa.newOpWin" />" onclick="fnView('<c:out value="${resultList.linknttSeq}"/>', '<c:out value="${resultList.linkUrl}"/>');">
								<c:if test="${resultVO.listScrinCode eq 'E'}">
					...
					<div class="event-txt">
						...
						<h3>
							<a href="javascript:void(0);" title="<spring:message code="wzwg.cmm.word.wa.newOpWin" />" onclick="fnView('<c:out value="${resultList.linknttSeq}"/>', '<c:out value="${resultList.linkUrl}"/>');"><c:out value="${nttSj}"/></a>
						</h3>
