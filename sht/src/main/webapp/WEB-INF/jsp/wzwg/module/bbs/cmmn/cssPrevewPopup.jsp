...
<title>::: <spring:message code="wzwg.cmm.word.preview" text="preview" /> :::</title>
...
<link rel="stylesheet" href="/css/wzwg/site/mngr/style.css" type="text/css" />
	...
	<table class="basic">
		...
		<tbody>
			<tr>
				<td>
					<img src='<c:out value="${moduleBbsCssVO.prevewPath }"/>' width="750" heigth="465"/>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<div class="ctr-box">
		<a href="javascript:void(0);" onclick="self.close();"><span class="btn-a"><spring:message code="wzwg.cmm.word.close" text="close" /></span></a>
	</div>
