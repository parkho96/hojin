	...
	$(document).ready(function(){
		...
		$('#modify_btn').click(function(){
			...
			if(!confirm('<spring:message code="wzwg.cmm.cmmMsg.CMG007"><spring:argument><spring:message code="wzwg.cmm.word.updt" /></spring:argument></spring:message>')){
				...
				$.ajax({
			        type : 'POST'
					, url : '<c:out value="${wzwg_contextPath}${prefix}"/>/module/ntt/mvp/modifyNttMvpInfoAjax.do'
				...
				<div class="subject">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="4">
								<textarea name="mvpCap" id="mvpCap" rows="20" style="width:100%;display:none;"><c:out value="${resultVO.mvpCap}"/></textarea>
