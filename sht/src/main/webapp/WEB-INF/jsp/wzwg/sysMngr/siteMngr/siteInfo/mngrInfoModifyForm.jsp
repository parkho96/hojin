...
<script type="text/javascript">
	...
	function fnUsrFormChange(usrtySeq) {
        ...
        $.ajax({
            type:'post'
            , url:'<c:out value="${wzwg_contextPath}" />/cmm/mber/sbscrb/selectSbscrbForm.do'
            , data:$("#frmCode").serialize()
            , dataType: 'html'
	...
	function numkeyCheck(e) { 
	 ...
	 function fn_usrInfoDelete(){
	  ...
	  <c:choose>
            ...
            <c:otherwise>
                <h3><spring:message code="wzwg.cmm.word.site" /> <spring:message code="wzwg.cmm.word.adiinfo" /></h3>
            </c:otherwise>
            </c:choose>
    ...
    <input type="hidden" name="chk" value="<c:out value="${infoVO.usrSeq}" />:<c:out value="${infoVO.siteSeq}" />" />
		...
		<tbody>
			...
			<tr>
              ...
              <tr>
                ...
                <td colspan="3">
                    <input type="text" class="sBox" id="zip" name="zip" readonly="readonly" value="<c:out value='${infoVO.zip}'/>"><a href="javascript:void(0);" onclick="execKakaoPostcode();" class="sebtn"><spring:message code="wzwg.sysMngr.word.zipSch02" /></a>
            ...
            <c:if test="${sessionScope.SYSMNGR_AT eq 'Y' || infoVO.usrtySeq eq '10000000307'}">
	...
	<div class="rt-box">
		<c:if test="${sessionScope.SYSMNGR_AT eq 'Y' }">
			<a href="javascript:void(0);" onclick="fn_usrInfoDelete();" class="wzbtn btn-del fl"><spring:message code="wzwg.cmm.word.delete" /></a>
		</c:if>
