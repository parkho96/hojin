	...
	$(document).ready(function(){
		...
		$('#modify_btn').click(function(){
			...
			if(!confirm('<spring:message code="wzwg.cmm.cmmMsg.CMG007"><spring:argument><spring:message code="wzwg.cmm.word.updt" /></spring:argument></spring:message>')){
				...
				$.ajax({
			        type : 'POST'
					, url : '<c:out value="${wzwg_contextPath}${prefix}" />/opnsu/ntt/unity/modifyNttInfoAjax.do'
		...
		$('#cancle_btn').click(function(){
			...
			var url = '<c:out value="${wzwg_contextPath}${prefix}" />/opnsu/ntt/unity/selectNttDetailAjax.do';
			
			if('<c:out value="${resultVO.bbsSeq}" />' == '10000000004') {
			...
			<table class="basic">
				  ...
				  <tbody>
					...
					<tr>
						...
						<td colspan="3">
							<form:checkbox path="noticeAt" name="noticeAt" value="Y" dir="required" /><spring:message code="wzwg.sysMngr.word.bbsNotice01" />
						</td>
					</tr>
					</c:if>
					</c:if>
					...
					<tr>
						...
						<td colspan="3">
							<form:checkbox path="answerPermAt" name="answerPermAt" value="Y" dir="required" /><span><spring:message code="wzwg.sysMngr.word.answr02Perm" /></span>
						</td>
					</tr>
					</c:if>
				  </tbody>
