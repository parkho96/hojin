...
function fnList(){
	...
	$.ajax({
		type:'POST'
		, url:'<c:out value="${wzwg_contextPath}" />/sysMngr/stat/selectUsrStatAjax.do'
...
function fnExcelDown(){
	document.statFrm.action="<c:out value="${wzwg_contextPath}" />/sysMngr/stat/selectUsrStatExcel.do";
