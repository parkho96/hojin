...
function fnList(){
	...
	$.ajax({
		type:'POST'
		, url:'<c:out value="${wzwg_contextPath}" />/mngr/stat/selectVisitStatAjax.do'
...
function fnExcelDown(){
	document.statFrm.action="<c:out value="${wzwg_contextPath}" />/mngr/stat/selectVisitStatExcel.do";
