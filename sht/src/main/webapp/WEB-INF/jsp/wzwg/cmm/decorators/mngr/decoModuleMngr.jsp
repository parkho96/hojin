          ...
          <div id="contents">
				<div id="main">
					...
					<c:set var="locationNm" />
           			 <c:if test="${fn:indexOf(nowUrl, '/sysMngr/moduleMngr/sysModuleInfo/') > -1}"><c:set var="locationNm"><spring:message code="wzwg.cmm.cntnts.sysmodulemanage"/></c:set></c:if>
           			 ...
           			 <c:if test="${fn:indexOf(nowUrl, '/cntntsMngr/cntntnsStyle/') > -1}"><c:set var="locationNm"><spring:message code="wzwg.cmm.cntnts.moduleskin"/></c:set></c:if>
						<div class="location-001">
							<ul>
								<li><img src="/images/wzwg/site/mngr/lo-home.png" alt="<spring:message code="wzwg.cmm.word.home" />" /></li>
				                <li><spring:message code="wzwg.cmm.cntnts.modulemanage"/></li>
